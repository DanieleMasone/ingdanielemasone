...
describe('PageSection', () => {
    ...
    it('uses the correct semantic elements and classes', () => {
        ...
        expect(section).toHaveClass('px-4 py-6 sm:px-6 md:px-8 max-w-7xl mx-auto');
        expect(heading).toBeInTheDocument();
        expect(heading).toHaveClass('text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 text-gray-900 dark:text-white');
    });
});
