...
export default function LanguageSwitcher() {
    ...
    return (
        <div ref={dropdownRef} className="relative inline-block text-left z-20">
            ...
            {open && (
                <div
                    className="absolute right-0 mt-2 w-[10rem] origin-top-right rounded-xl
                             bg-white/90 dark:bg-gray-800/90 shadow-lg ring-1 ring-black/10
                               backdrop-blur-md overflow-hidden animate-fade-in"
                    role="menu"
                ...
                >
                    {Object.entries(flags).map(([lang, flagUrl]) => {
                        ...
                        return (
                            ...
                            ${isActive ? "bg-blue-50 dark:bg-blue-900/40 font-semibold" : ""}`}
                                role="menuitem"
                                type="button"
                            >
                                <img
