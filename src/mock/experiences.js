/**
 * Static career and education entries displayed by the Experience page.
 *
 * Role and description fields are translation keys. Category explicitly owns
 * the page section; never infer it from companies or translation keys. Period
 * strings are used for ordering, so keep years in a parsable four-digit format.
 *
 * @type {Array<{role: string, company: string, period: string, description: string, tech: string, category: "professional" | "education"}>}
