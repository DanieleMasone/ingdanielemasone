...
describe('Courses component', () => {
    ...
    test("discloses the commercial nature of direct purchase links", async () => {
        vi.spyOn(service, "getCourses").mockResolvedValue(mockCourses);
    ...
    test("renders course cover images inside a fixed-height media frame", async () => {
        vi.spyOn(service, "getCourses").mockResolvedValue(mockCourses);
        ...
        expect(frame).toHaveClass("h-48", "overflow-hidden", "bg-black");
